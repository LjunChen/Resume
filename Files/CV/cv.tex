...
\begin{minipage}[c]{0.5\textwidth}
    ...
    \href{https://ljunchen.github.io/Resume/}{My Homepage} \\
...
\begin{enumerate}[leftmargin=2ex]
    \setlength{\itemsep}{-1pt} 
    \item Chen, L., Li, D. and Zhou C. (2021) Distributed inference for extreme value index. {\it Biometrika}, accepted.
   
    \item Chen, L., Li, D. and Zhou C. (2021) Asymptotic unbiased distributed estimator for extreme value index. Submitted.

    \item Li, Y., Chen, L. , Li, D. and Wang H. (2020) \href{https://arxiv.org/abs/2007.02037}{Estimating extreme value index by subsampling for massive datasets with heavy-tailed distributions.} Submitted.
\end{enumerate}
